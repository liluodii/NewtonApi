...
public class first_fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        layoutView = view;
        onResultClick = view.findViewById(R.id.btnquadresult);
        expression = view.findViewById(R.id.quadExpression);

        final Spinner dropdown = view.findViewById(R.id.spinner_quadratic);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.quadratic, container, false);
    }
