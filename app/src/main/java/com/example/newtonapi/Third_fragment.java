...
public class Third_fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        layoutView = view;
        onResultClick = view.findViewById(R.id.btnlogresult);
        expression = view.findViewById(R.id.logExpression);

        final Spinner dropdown = view.findViewById(R.id.spinner_log);
        String[] items = new String[]{"Log"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.logarithmic, container, false);
    }
